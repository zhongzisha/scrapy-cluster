...
class ZookeeperHandler(BaseHandler):
    ...
    def setup(self, settings):
        ...
        '''
        self.logger.info("Redis Info {}:{}, {}".format(settings['REDIS_HOST'],
                                                        settings['REDIS_PORT'],
        ...
        try:
            ...
            self.logger.info("Connected to Redis in ZookeeperHandler")
    ...
    def handle(self, dict):
        ...
        self.logger.info("handle in ZookeeperHandler")
