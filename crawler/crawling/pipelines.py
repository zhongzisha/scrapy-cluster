...
class KafkaPipeline(object):
    ...
    def from_settings(cls, settings):
        ...
        try:
            logger.info("create Kafka producer in Pipeline")
    ...
    def _kafka_success(self, item, spider, response):
        ...
        '''
        self.logger.info("Begin Sent page to Kafka")
        item['success'] = True
        ...
        if True:  # try:
            ...
            try:
                if self.use_base64:
                    ...
                    datum['body'] = base64.b64encode(datum['body']).decode('utf-8')
                message = ujson.dumps(datum, sort_keys=True)  # this is a str-like object
            except:
            ...
            if self.appid_topics:
                ...
                self.logger.info("Send to Kafka {}, {}", appid_topic, message)
