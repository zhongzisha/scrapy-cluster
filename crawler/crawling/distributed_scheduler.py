...
class DistributedScheduler(object):
    ...
    def __init__(self, server, persist, update_int, timeout, retries, logger,
        ...
        self.logger.info("update_ipaddress done")

        # if we need better uuid's mod this line
        self.logger.info("get uuid")
        self.my_uuid = str(uuid.uuid4()).split('-')[4]
        self.logger.info("get uuid done")

    def setup_zookeeper(self):
        self.assign_path = settings.get('ZOOKEEPER_ASSIGN_PATH', "")
        self.my_id = settings.get('ZOOKEEPER_ID', '1')
        self.logger.info("Trying to establish Zookeeper connection")
        try:
            self.logger.info("Trying to establish Zookeeper connection {}".format(settings.get('ZOOKEEPER_HOSTS')))
    ...
    def load_domain_config(self, loaded_config):
        ...
        self.logger.info("load_domain_config done")
    ...
    def update_domain_queues(self):
        ...
        '''
        self.logger.info("update_domain_queues")
    ...
    def create_queues(self):
        ...
        self.logger.info("create_queues")
        ...
        self.logger.info("create_queues done")
    ...
    def expire_queues(self):
        ...
        '''
        self.logger.info("expire_queues")
        curr_time = time.time()
    ...
    def update_ipaddress(self):
        ...
        # if True:  # try:
        #     url = settings.get('PUBLIC_IP_URL', 'http://ip.42.pl/raw')
        #     print('url', url)
    ...
    def from_settings(cls, settings):
        ...
        logger = LogFactory.get_instance(json=my_json,
                                         ...
                                         bytes=my_bytes,
                                         backups=my_backups)
        logger.info('from_settings distributed_scheduler')
    ...
    def open(self, spider):
        self.logger.info("Opening Spider", {'spiderid': spider.name})
        self.spider = spider
        self.spider.set_logger(self.logger)
        self.logger.info("Creating Queues")
        self.create_queues()
        self.logger.info("setup_zookeeper")
        self.setup_zookeeper()
        self.logger.info("RFPDupeFilter")
    ...
    def is_blacklisted(self, appid, crawlid):
        ...
        self.logger.info("Checks the redis blacklist for crawls that should not be propagated")
    ...
    def find_item(self):
        ...
        self.logger.info("Finds an item from the throttled queues")
