...
class StatsMonitor(KafkaBaseMonitor):
    ...
    def get_all_stats(self):
        ...
        '''
        self.logger.info("Gathering all stats")
        the_dict = {}
    ...
    def get_kafka_monitor_stats(self):
        ...
        '''
        self.logger.info("Gathering kafka-monitor stats")
    ...
    def get_redis_monitor_stats(self):
        ...
        @return: A dict of stats
        '''
        self.logger.info("Gathering redis-monitor stats")
    ...
    def get_rest_stats(self):
        ...
        @return: A dict of stats
        '''
        self.logger.info("Gathering rest stats")
    ...
    def get_spider_stats(self):
        ...
        '''
        self.logger.info("Gathering spider stats")
        the_dict = {}
        spider_set = set()
    ...
    def get_machine_stats(self):
        ...
        Gather spider based stats
        '''
        self.logger.info("Gathering machine stats")
        the_dict = {}
        keys = self.redis_conn.keys('stats:crawler:*:*:*:*')
    ...
    def get_crawler_stats(self):
        ...
        @return: A dict of stats
        '''
        self.logger.info("Gathering crawler stats")
        the_dict = {}
    ...
    def get_queue_stats(self):
        ...
        @return: A dict of stats
        '''
        self.logger.info("Gathering queue based stats")
