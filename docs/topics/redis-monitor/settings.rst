...
The amount of time the statistics key the Redis Monitor instance lives to cls identify to the rest of the cluster. Used for retrieving stats about the number of Redis Monitor instances currently running.
